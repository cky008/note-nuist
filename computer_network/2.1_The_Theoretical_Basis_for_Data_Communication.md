...
<img src="https://latex.codecogs.com/svg.image?g(t)=\frac{1}{2}c&plus;\sum_{n=1}^{\infty}a_n&space;sin(2\pi&space;nft)&plus;\sum_{n=1}^{\infty}b_ncos(2\pi&space;nft)" title="g(t)=\frac{1}{2}c+\sum_{n=1}^{\infty}a_n sin(2\pi nft)+\sum_{n=1}^{\infty}b_ncos(2\pi nft)" />
基频: <img src="https://latex.codecogs.com/svg.image?f=\frac{1}{T}" title="f=\frac{1}{T}" />
n次谐波的振幅: $a_n$ 和 $b_n$
对于给定的$g(t)$和$T$, 可推导出:
